...
select replace(lower(col3), '._', '_'),'\copy ' + replace(replace(replace(lower(col3), '"', ''),'._','.'),'dbo','public') + ' FROM ' + char(39) + @folderPath + replace(lower(col3), '"', '') + '.csv' + char(39) + ' DELIMITER ' + char(39) + '~' + char(39) + ' null as ' + char(39) + 'null' + char(39) + '  encoding ' + char(39) + 'utf8' + char(39) + ' CSV;' + char(13)
